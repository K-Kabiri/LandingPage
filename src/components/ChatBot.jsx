...
const ChatBot = () => {
  const [messages, setMessages] = useState([
    ...
    //     sender: "bot",
    // },
    // { id: 4, text: "سلام، در مورد سینتا بهم بگو", sender: "user" },
    // {
    //     id: 5,
    //     text: "پلتفرم سینتا یک پلتفرم کم‌کد برای طراحی فرایندهای کسب‌وکار است.",
    //     sender: "bot",
  ...
  return (
    <>
      {isOpen && (
        <Box
          className="w-80 h-[30rem] bg-white rounded-3xl border border-slate-300 flex flex-col justify-between shadow-lg"
          style={{
            position: "fixed",
            bottom: "90px",
            right: "20px",
        ...
        >
          <Box className="flex flex-row justify-between w-full px-4 py-3 rounded-t-3xl bg-contain bg-no-repeat items-start h-28">
            <div
            ...
            >
              ...
              >
                <path
                  d="M15.7756 5.77566L16.4308 3.81026H17.5692L18.2243 5.77566L20.1897 6.43079V7.56921L18.2243 8.22434L17.5692 10.1897H16.4308L15.7756 8.22434L13.8102 7.56921V6.43079L15.7756 5.77566Z"
                  fill="currentColor"
                />
                ...
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M7.33728 6H10.6627L14.0329 19H11.9668L11.1891 16H6.81082L6.03304 19H3.96692L7.33728 6ZM7.32934 14H10.6706L9.11505 8H8.88489L7.32934 14Z"
                  fill="currentColor"
                />
              </svg>
              <RobotIcon />
              ...
              InputProps={{
                endAdornment: (
                  <InputAdornment position="end">
                    <IconButton
                      className="rounded-full shadow-lg/20 !p-1.5"
                      style={{
                        backgroundColor: theme.palette.primary.light,
                      }}
                      sx={{
      ...
      <Box
        className="h-fit w-fit rounded-full p-3 shadow-lg/30 cursor-pointer"
        style={{
      ...
      >
        ...
        >
          <path
            d="M27.7395 16.0145H27.5528C26.7862 12.5878 23.7262 10.0145 20.0728 10.0145H17.7395V9.16118C18.8995 8.74785 19.7395 7.64785 19.7395 6.34785C19.7395 4.69451 18.3928 3.34785 16.7395 3.34785C15.0862 3.34785 13.7395 4.69451 13.7395 6.34785C13.7395 7.64785 14.5795 8.74785 15.7395 9.16118V10.0145H13.4062C9.75284 10.0145 6.69284 12.5878 5.92617 16.0145H5.7395C4.6395 16.0145 3.7395 16.9145 3.7395 18.0145V20.0145C3.7395 21.1145 4.6395 22.0145 5.7395 22.0145H6.10617C6.89284 24.4678 8.8795 26.3745 11.3728 27.0678C11.1862 27.4612 11.0728 27.8878 11.0728 28.3478C11.0728 28.9012 11.5195 29.3478 12.0728 29.3478H21.4062C21.9595 29.3478 22.4062 28.9012 22.4062 28.3478C22.4062 27.8878 22.2928 27.4545 22.1062 27.0678C24.5995 26.3812 26.5862 24.4678 27.3728 22.0145H27.7395C28.8395 22.0145 29.7395 21.1145 29.7395 20.0145V18.0145C29.7395 16.9145 28.8395 16.0145 27.7395 16.0145ZM16.7395 5.34785C17.2928 5.34785 17.7395 5.79451 17.7395 6.34785C17.7395 6.90118 17.2928 7.34785 16.7395 7.34785C16.1862 7.34785 15.7395 6.90118 15.7395 6.34785C15.7395 5.79451 16.1862 5.34785 16.7395 5.34785ZM20.0728 25.3478H13.4062C10.2795 25.3478 7.7395 22.8078 7.7395 19.6812V17.6812C7.7395 14.5545 10.2795 12.0145 13.4062 12.0145H20.0728C23.1995 12.0145 25.7395 14.5545 25.7395 17.6812V19.6812C25.7395 22.8078 23.1995 25.3478 20.0728 25.3478Z"
            fill="currentColor"
          />
          <path
            d="M13.0728 14.6812C11.9728 14.6812 11.0728 15.5812 11.0728 16.6812V18.6812C11.0728 19.7812 11.9728 20.6812 13.0728 20.6812C14.1728 20.6812 15.0728 19.7812 15.0728 18.6812V16.6812C15.0728 15.5812 14.1728 14.6812 13.0728 14.6812Z"
            fill="currentColor"
          />
          <path
            d="M20.4062 14.6812C19.3062 14.6812 18.4062 15.5812 18.4062 16.6812V18.6812C18.4062 19.7812 19.3062 20.6812 20.4062 20.6812C21.5062 20.6812 22.4062 19.7812 22.4062 18.6812V16.6812C22.4062 15.5812 21.5062 14.6812 20.4062 14.6812Z"
            fill="currentColor"
          />
          <path
            d="M9.7595 5.29452L11.7595 5.96118C11.8662 5.99451 11.9728 6.01451 12.0728 6.01451C12.4928 6.01451 12.8795 5.74785 13.0195 5.32785C13.1928 4.80118 12.9128 4.23452 12.3862 4.06118L10.3862 3.39452C9.86617 3.22118 9.2995 3.50118 9.1195 4.02785C8.9395 4.55452 9.22617 5.12118 9.75284 5.29452H9.7595Z"
            fill="currentColor"
          />
          <path
            d="M10.0728 9.34785C10.1795 9.34785 10.2862 9.33451 10.3862 9.29451L12.3862 8.62785C12.9128 8.45451 13.1928 7.88785 13.0195 7.36118C12.8462 6.83451 12.2795 6.55451 11.7528 6.72785L9.75284 7.39451C9.22617 7.56785 8.94617 8.13451 9.1195 8.66118C9.2595 9.08118 9.64617 9.34785 10.0662 9.34785H10.0728Z"
            fill="currentColor"
          />
          <path
            d="M21.4062 6.01451C21.5128 6.01451 21.6195 6.00118 21.7195 5.96118L23.7195 5.29452C24.2462 5.12118 24.5262 4.55452 24.3528 4.02785C24.1795 3.50118 23.6128 3.22118 23.0862 3.39452L21.0862 4.06118C20.5595 4.23452 20.2795 4.80118 20.4528 5.32785C20.5928 5.74785 20.9795 6.01451 21.3995 6.01451H21.4062Z"
            fill="currentColor"
          />
          <path
            d="M21.0928 8.62785L23.0928 9.29451C23.1995 9.32785 23.3062 9.34785 23.4062 9.34785C23.8262 9.34785 24.2128 9.08118 24.3528 8.66118C24.5262 8.13451 24.2462 7.56785 23.7195 7.39451L21.7195 6.72785C21.1995 6.55451 20.6262 6.83451 20.4528 7.36118C20.2795 7.88785 20.5595 8.45451 21.0862 8.62785H21.0928Z"
            fill="currentColor"
          />
        </svg>
      </Box>
