      ...
      <div className="flex flex-col max-w-[1280px] w-[100%] gap-10 px-4 md:px-16">
        <div className="flex flex-col gap-10 text-center">
          <h2 className="text-3xl font-bold">
            <span style={{ color: theme.palette.primary.main }}>{data.title}</span> {data.subtitle}
          </h2>
            ...
            {steps.map((step, idx) => (
              ...
              >
                <div className="text-end w-1/3">
                  ...
                  {step.subtitle && <span className="block font-semibold">{step.subtitle}</span>}
