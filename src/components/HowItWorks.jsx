...
const steps = [
    ...
    },
    {
        ...
        subtitle: (
            <>
                سوالی دارید؟ چک کنید <a className=" underline" style={{color:theme.palette.primary.main}} href="#">سوالات متداول</a>
            </>
        ),
...
const HowItWorks = () => {
    return (
        <section
            id="how_it_work"
            className="bg-white md:px-10 px-2 py-10 flex flex-col gap-16 w-full"
        >
            <div className="flex flex-col gap-10 text-center">
                ...
                <p className="mt-4 text-gray-600">
                    سینتا امکان ایجاد نرم‌افزارهای سفارشی و متناسب با نیازهای کسب‌وکاری شرکت‌های مختلف در زمانی کوتاه‌تر از روش‌های سنتی را در سه مرحله کلی فراهم نموده است
                </p>
            </div>
